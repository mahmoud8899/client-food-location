...
<h1 style={Styles.color} className="container_color_footer_h1">Your Logo</h1>
...
<div className="container_color_footer_About">
    <h1 style={Styles.color} className="container_color_footer_h1">Contact Us</h1>
    <div className="Icons_row">
        <i style={Styles.icon} className="fas fa-phone-volume "></i>
...
<Col xs={12} sm={6} md={3} log={3}>
<h1 style={Styles.color} className="container_color_footer_h1">Information</h1>
...
<Col xs={12} sm={6} md={3} log={3}>
<h1 style={Styles.color} className="container_color_footer_h1">Helpful Links</h1>
<div className="search_more_icons">
    <span>Services</span>
    <span>Supports</span>
...
<Col xs={12} sm={6} md={3} log={3}>
<h1 style={Styles.color} className="container_color_footer_h1">Subscribe More Info</h1>
<Form>
    <Input
...
<Row  style={Styles.Show}  className="justify-content-center Footer_onder">
<Col xs={12} md={6} lg={6} style={Styles.box} >
<div className="icons_alle">
    <span className="reutor_icons">
        <i  style={Styles.icons} className="fab fa-facebook"></i>
    </span>
    <span className="reutor_icons">
        <i style={Styles.icons}className="fab fa-google"></i>
    </span>

    <span className="reutor_icons">
        <i style={Styles.icons}className="fab fa-twitter"></i>
    </span>

    <span className="reutor_icons">
        <i style={Styles.icons}className="fab fa-instagram-square"></i>
    </span>
